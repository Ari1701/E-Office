    ...
    <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto" style="height: 100%;">
            <ul class="nav flex-column" style="height: 100%; overflow-y: auto;">
                <li class="nav-item {{ Request::is('/komitetim/tambahsurat') ? 'active' : '' }}">
                    <a class="nav-link mb-3 mt-2" href="/tambahsuratkomite">
                    <i class="bi bi-envelope-arrow-down-fill"></i>
                         Tambah NotaDinas
                    </a>
                </li>
                <li class="nav-item {{ Request::is('/komitetim/info') ? 'active' : '' }}">
                    <a class="nav-link mb-3 mt-2" href="/infosuratkomite">
                    <i class="bi bi-envelope-arrow-down-fill"></i>
                         Cek Surat Disposisi
                    </a>
                </li>
                <li class="nav-item {{ Request::is('/komitetim/infosuratnotadinas') ? 'active' : '' }}">
                    <a class="nav-link mb-3" href="/infosuratnotadinaskomite">
                    <i class="bi bi-envelope-arrow-down-fill"></i>
                         Cek Surat Notadinas
                    </a>
                </li>
