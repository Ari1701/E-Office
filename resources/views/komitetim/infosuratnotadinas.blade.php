        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header bg-primary">
                    <h5 class="card-title text-white">Semua Surat Notadinas Komite & Tim</h5>
                    <form action="{{ route('komitetim.infosuratnotadinas') }}" method="GET">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('view.pdf', ['id' => $notadinas->id]) }}" target="_blank" class="btn btn-info">
