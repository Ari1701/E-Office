        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header bg-primary">
                    <h5 class="card-title text-white">Semua Surat Notadinas Direktur Medis</h5>
                </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('viewnotadinasdirmed', ['id' => $notadinas->id]) }}" target="_blank" class="btn btn-info">
