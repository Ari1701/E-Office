@extends('manajer.timkhususit.layouts.main')
                        ...
                        <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('manajer.timkhususit.edit', ['id' => $notadinas->id]) }}" class="btn btn-primary">Edit</a>
                                    </td>                                   
                                    <td>{{ $notadinas->pengirim }}</td>
                                    <td>{{ $notadinas->pesan }}</td>
                                    <td>
                                        <a href="{{ route('viewnotadinasmanajerit', ['id' => $notadinas->id]) }}" target="_blank" class="btn btn-info">
