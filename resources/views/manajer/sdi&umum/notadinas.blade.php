                        ...
                        <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('manajer.adm&keu.edit', ['id' => $notadinas->id]) }}" class="btn btn-primary">Edit</a>
                                    </td>                                   
                                    <td>{{ $notadinas->pengirim }}</td>
                                    <td>{{ $notadinas->pesan }}</td>
                                    <td>
                                        <a href="{{ route('notadinasmanajersdi', ['id' => $notadinas->id]) }}" target="_blank" class="btn btn-info">
