...
<form method="POST" action="{{ route('sekertaris.store') }}" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="departemen">Penerima</label>
        <select name="departemen" id="departemen" class="form-select">
            ...
            <option value="Kepala Instalasi Anestesi & Perawatan Instensif">Kepala Instalasi Anestesi & Perawatan Instensif</option>
            ...
            <option value="Kepala Instalasi Laboratprium">Kepala Instalasi Laboratprium</option>
