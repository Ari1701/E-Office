@extends('administrasi.layouts.main')
        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header bg-primary">
                    <h5 class="card-title text-white">Semua Surat Notadinas KABAG ADM & Keu</h5>
                    <form action="{{ route('administrasi.infosuratnotadinas') }}" method="GET">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('viewnotadinasadministrasi', ['id' => $notadinas->id]) }}" target="_blank" class="btn btn-info">
