        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header bg-primary">
                    <h5 class="card-title text-white">Semua Surat Notadinas Tim IT</h5>
                    <form action="{{ route('it.infosuratnotadinas') }}" method="GET">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('viewnotadinas', ['id' => $notadinas->id]) }}" target="_blank" class="btn btn-info">
