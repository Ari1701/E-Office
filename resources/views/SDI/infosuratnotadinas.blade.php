        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header bg-primary">
                    <h5 class="card-title text-white">Semua Surat Notadinas KABAG SDI</h5>
                    <form action="{{ route('SDI.infosuratnotadinas') }}" method="GET">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('viewnotadinasSDI', ['id' => $notadinas->id]) }}" target="_blank" class="btn btn-info">
