        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header bg-primary">
                    ...
                    <form action="{{ route('dirum.notadinas') }}" method="GET">
                        ...
                        <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('viewnotadinasdirum', ['id' => $notadinas->id]) }}" target="_blank" class="btn btn-info">
