...
class KabagHumasController extends Controller
{
    public function tambahsurat()
    {
        $notadinas = Notadinas::all();
        return view('humas.tambahsurat', compact('notadinas'));
    }

    public function show()
    {
        $notadinas = Notadinas::whereIn('pengirim', ['Humas & PKRS'])->get();
        return view('humas.infosuratnotadinas', compact('notadinas'));
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('humas.tambahsurat')->with('success', 'Nota Dinas berhasil dibuat.');
    }

    public function viewdispohumas($id)
    {
